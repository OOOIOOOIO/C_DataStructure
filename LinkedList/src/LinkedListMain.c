...
int main(void){
	...
	list_add(&myList, 45);
	printList(&myList); // [100, 50, 100, 20, 45]
	list_add(&myList, 75);
	printList(&myList); // [100, 50, 100, 20, 45, 75]
	...
	printList(&myList);		  // [40, 30, 100, 20, 30, 75]으로 수정됨
	...
	// 데이터 삭제
	printf("섹제 전\n");
	printList(&myList); // [40, 30, 100, 20, 30, 75]
	printf("섹제 후\n");
	list_remove(&myList, 2);
	printList(&myList); // [40, 30, 20, 30, 75]
	list_remove(&myList, 2);
	printList(&myList); // [40, 30, 30,  75]
	printf("데이터 개수는 %d\n", list_length(&myList)); // 2
	list_remove(&myList, 0);
	printList(&myList);  // [30, 30, 75]
	list_remove(&myList, 0);
	printList(&myList);  // [30, 75]
	list_remove(&myList, 0);
	list_remove(&myList, 0);
	printList(&myList);  // []
	...
	printList(&myList); // [50, 5, 10, 40, 20]
	printf("데이터 개수는 %d\n", list_length(&myList)); // 5
	printf("\n");
